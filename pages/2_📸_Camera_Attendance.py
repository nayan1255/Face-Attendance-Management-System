...
st.set_page_config(page_title="Face Attendance Management System", page_icon="📊", layout="wide")

st.title(":camera: Camera Attendance")
st.write("---")


saved_df = pd.read_csv(r"data\\encodings.csv")
...
df = pd.read_csv("data\\Attendance\\" +
...
while start:
    ...
    if face_names:
        for face_loc, name in zip(face_locations, face_names):
            ...
            with open("data\\Attendance\\" + name_of_attendence_sheet+".csv", 'a') as csv_file:
